...
\item the acceleration of the UAV, $\ddot{x}_k$, in \emph{NED} frame, obtained by differentiating the velocities.\todo[noinline]{These values are also described on the next page.}
