...
\todo{Not comments but todos here (for Henrik) ¯\\_(ツ)_/¯

[Ad3:] the math here is really unecessarily complicated >:P . I can change it the robo-gang way. Your formatting of where up is definitely interesting; when I started writing papers with math I also had this thing of writing my way. Then came Hector one day and told me that only once I am known enough I can change the status quo in the math notation; so now I am little autistic about it all the time :)

[Ad3:] there are fixes with ts here and there. Also; you have a time dependent timestep dt. Please, don't use dt. What is that? It seems differentiation. Is soooo confusing. I can help to simplify. Just tell me!}
