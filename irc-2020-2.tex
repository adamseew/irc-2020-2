...
pose over an altitude range of \SI{0}{}-\SI{20}{\m}. Our work is in constrast focused on
...
%
% [Ad3:] Ulrik, the sentence seems to fit better in SoA? Yes, nice! /ups
%
...
\end{align*}
\todo{
  Ad3: Actually $G_k$ might still go easily inline. Something like (commented because latex generates error). Up to you
  % Here: $G_k=\Delta t_k\begin{bmatrix}I & \Delta t_kI/2 & -I\end{bmatrix}$
}
...
640$\times$480 pixel image at 10~fps. An Nvidia Jetson Nano
