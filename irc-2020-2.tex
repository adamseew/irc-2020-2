...
%
the Central Processing Unit (CPU) should be used for detecting the landing marker. 
By doing so,
...
the energy impact of different configurations of the Robot Operating System (ROS)-based system
...
laptop. The $PX4$ Software In The Loop (STIL) Firmware v1.10.2 is used as the flight
