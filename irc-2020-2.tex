...
perform all computations on \emph{Nvidia Jetson Nano} and analyse %we attempt to
...
Experiments are conducted using a Gazebo simulation using the \emph{powprofiler} energy
modeling tool to measure the energy cost as a function of quality of service. %for autonomous
