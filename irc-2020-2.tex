...
The input matrix and associated control input is given by:
\begin{align*}
G_{k} & = \begin{bmatrix}
...
\todo{Georgios: What are the value of the initial covariance matrix?}
...
\todo[noinline]{Where do these position measurements come from? the tractor gps?}
\todo[noinline]{Fix loose sentence here.}
