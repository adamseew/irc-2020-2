...
%
Since GPS signals
can be temporarily lost or even tampered with, in this paper we investigate the use of a novel
...
A custom dataset based on the Gazebo models was created. The dataset consists of 1200 images, 300
...
\emph{landing} modes are tested under three different cases of no wind, \SI{8}{\meter \per \second} and \SI{12}{\meter \per \second} wind disturbances as analysed in Section~\ref{sec:WindDisturbances}.
