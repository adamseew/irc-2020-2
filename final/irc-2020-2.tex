...
objects were detected. This is expected since at a higher fps each object is viewed more times at different angles as the UAV moves. Nevertheless, for the same high fps values but
